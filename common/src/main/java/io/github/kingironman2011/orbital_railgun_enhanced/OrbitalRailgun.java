...
public class OrbitalRailgun implements ModInitializer {
    ...
    // Packet IDs used by version-specific network payloads
    public static final Identifier SHOOT_PACKET_ID = new Identifier(MOD_ID, "shoot");
    public static final Identifier CLIENT_SYNC_PACKET_ID = new Identifier(MOD_ID, "client_sync");
